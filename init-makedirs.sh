...
echo "Do not forget to checkout repository 'seminar' into data/seminar (write access required)."
echo "Do not forget to checkout repository 'module_lib' into data/module_lib (read access in enough)."
